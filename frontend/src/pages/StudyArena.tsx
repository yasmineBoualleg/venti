  ...
  return (
    <div className="min-h-screen bg-light-bg relative overflow-hidden pt-4 pb-20">
      ...
      <div className="relative max-w-4xl mx-auto px-4 pt-20">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-4">⚔️ Study Arena</h1>
          <p className="text-gray-600 text-lg">Challenge yourself with quizzes and competitions</p>
